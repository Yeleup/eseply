...
.PHONY: help init ensure-vendor ensure-node-modules build up down down-volumes restart logs ps shell artisan composer npm key-show key-generate dump import dump-media import-media test deploy
