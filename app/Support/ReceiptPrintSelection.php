...
class ReceiptPrintSelection
{
     ...
     * выбранные» и «Печатать по фильтру». Печать отдаётся потоком порциями,
     * поэтому память запроса от размера выборки почти не зависит: 10 000
     * квитанций — около 260 запросов, 21 МБ и 5 секунд. Предел ограничивает
     * прежде всего объём страницы в браузере.
     */
