...
return [
    ...
    'notifications' => [
        'print_selected_opened' => [
            'title' => 'Таңдалған түбіртектерді басып шығару жаңа қойындыда ашылды',
            'body' => 'Қойынды ашылмаса, «Ашу» түймесін басыңыз.',
        ],
        'print_selected_too_many' => [
            'title' => 'Таңдалған түбіртектер саны :limit шегінен асады',
            'body' => 'Таңдауды азайтыңыз немесе «Фильтр бойынша басып шығару» әрекетін қолданыңыз: таңдалған жолдарды бір рет басып шығару :limit түбіртекпен шектелген.',
        ],
    ],
];
