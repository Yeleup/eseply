...
return [
    ...
    'notifications' => [
        'print_selected_opened' => [
            'title' => 'Печать выбранных квитанций открыта в новой вкладке',
            'body' => 'Если вкладка не открылась, нажмите «Открыть».',
        ],
        'print_selected_too_many' => [
            'title' => 'Выбрано больше :limit квитанций',
            'body' => 'Сузьте выбор или используйте «Печатать по фильтру»: одна массовая печать выбранных строк ограничена :limit квитанциями.',
        ],
    ],
];
