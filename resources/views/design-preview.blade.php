            ...
            <section class="overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
                <div class="flex flex-col gap-4 border-b border-zinc-200 p-4 dark:border-zinc-800 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <p class="mt-2 max-w-2xl text-sm text-zinc-500 dark:text-zinc-400">
                            Список отчётов показывает показания, оплаты, неоплаченные квитанции, установку/замену счётчиков, долги, потребления, новые лицевые счета и оборотно-сальдовую ведомость. На странице отчёта доступны возврат к списку и скачивание Excel-файла.
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-3 border-b border-zinc-200 p-4 dark:border-zinc-800 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div class="rounded-lg border border-violet-200 bg-violet-50 p-4 dark:border-violet-900/60 dark:bg-violet-950/30">
                        <p class="text-xs font-semibold uppercase tracking-wide text-violet-700 dark:text-violet-300">Новый отчёт</p>
                        <h3 class="mt-2 font-semibold">Оборотно-сальдовая ведомость</h3>
                        <p class="mt-1 text-sm text-violet-800/80 dark:text-violet-200/80">Сальдо и обороты за выбранный расчётный месяц.</p>
                    </div>
                </div>
                ...
                <div class="border-b border-zinc-200 p-4 dark:border-zinc-800">
                    <div>
                        ...
                        <p class="mt-1 max-w-3xl text-sm text-zinc-500 dark:text-zinc-400">
                            Каждая колонка даты детального отчёта фильтруется диапазоном с включительными границами. Активные границы отображаются индикаторами над таблицей и снимаются по отдельности. Сводный режим фильтры не учитывает; XLSX-выгрузка детального режима повторяет применённые фильтры по датам вместе с фильтрами по адресу и контроллерам.
                        </p>
                    </div>
                ...
                <div class="border-b border-zinc-200 p-4 dark:border-zinc-800">
                    <div>
                        <p class="text-sm font-medium text-violet-700 dark:text-violet-300">Фильтры по адресу и контроллерам</p>
                        <h3 class="mt-1 text-base font-semibold">Адрес каскадом и зоны контроллеров</h3>
                        <p class="mt-1 max-w-3xl text-sm text-zinc-500 dark:text-zinc-400">
                            В детальном режиме ведомости снятия показаний, оборотно-сальдовой ведомости, списка не снятых показаний, новых лицевых счетов, отчётов по оплатам, неоплаченным, долгам и потреблениям и отчёта «Замена/установка счётчика» есть фильтры по городу, району и улицам абонента и по контроллерам. Город сужает список районов, район — список улиц. Улиц и контроллеров можно выбрать несколько. Фильтры по датам отчёта остаются рядом, сводный режим фильтры не учитывает.
                        </p>
                    </div>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="rounded-lg border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-900/60 dark:bg-emerald-950/30">
                                ...
                                <p class="mt-2 text-sm text-emerald-800/80 dark:text-emerald-200/80">
                                    «Скачать Excel» в детальном режиме выгружает те же строки, что видны на экране с теми же фильтрами: выгрузка повторяет применённые фильтры по адресу, контроллерам и датам. Отложенные значения, которые ещё не применены кнопкой, в выгрузку не попадают. Поиск по таблице на выгрузку по-прежнему не влияет.
                                </p>
                                <p class="mt-2 text-sm text-emerald-800/80 dark:text-emerald-200/80">
                ...
                <div class="border-b border-zinc-200 p-4 dark:border-zinc-800">
                    <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                        <div>
                            <p class="text-sm font-medium text-violet-700 dark:text-violet-300">Оборотно-сальдовая ведомость</p>
                            <h3 class="mt-1 text-base font-semibold">Сальдо и обороты за выбранный расчётный месяц</h3>
                            <p class="mt-1 max-w-3xl text-sm text-zinc-500 dark:text-zinc-400">
                                Дебет — долг абонента, кредит — переплата. Дебет оборота складывается из начисления и положительной корректировки, кредит оборота — из оплаты и модуля отрицательной корректировки. Разложение считается по каждому абоненту, поэтому группа показывает и общий долг, и общую переплату. Строка «Итого» сходится: дебет минус кредит слева равен дебету минус кредит справа. Колонка объёма подписана единицей измерения услуги организации и заполняется только для расчёта по счётчику; у абонентов с фиксированной суммой и с расчётом на одного человека там стоит прочерк.
                            </p>
                        </div>

                        <div class="flex flex-wrap gap-2">
                            <button class="inline-flex items-center gap-2 rounded-md border border-zinc-300 px-3 py-2 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-950">
                                Расчётный месяц: 05.2026
                            </button>
                            <button class="rounded-md bg-violet-700 px-3 py-2 text-sm font-medium text-white transition hover:bg-violet-800 dark:bg-violet-400 dark:text-zinc-950 dark:hover:bg-violet-300">
                                Детально
                            </button>
                            <button class="rounded-md border border-zinc-300 px-3 py-2 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100 dark:border-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-950">
                                По городам
                    ...
                    <div class="mt-4 overflow-x-auto rounded-lg border border-zinc-200 dark:border-zinc-800">
                        <table class="w-full min-w-280 text-left text-sm">
                            <thead class="bg-violet-50 text-xs font-semibold uppercase text-violet-800 dark:bg-violet-950/40 dark:text-violet-200">
                                <tr>
                                    <th class="px-4 py-2 align-bottom" rowspan="2">Лицевой счёт</th>
                                    <th class="px-4 py-2 align-bottom" rowspan="2">Абонент</th>
                                    <th class="px-4 py-2 align-bottom" rowspan="2">Адрес</th>
                                    <th class="border-l border-violet-200 px-4 py-2 align-bottom dark:border-violet-900/60" rowspan="2">Объём, м3</th>
                                    <th class="border-l border-violet-200 px-4 py-2 text-center dark:border-violet-900/60" colspan="2">Сальдо на начало периода</th>
                                    <th class="border-l border-violet-200 px-4 py-2 text-center dark:border-violet-900/60" colspan="2">Обороты за период</th>
                                    <th class="border-l border-violet-200 px-4 py-2 text-center dark:border-violet-900/60" colspan="2">Сальдо на конец периода</th>
                                    <th class="border-l border-violet-200 px-4 py-2 text-center dark:border-violet-900/60" colspan="3">Расшифровка оборотов</th>
                                </tr>
                                <tr>
                                    <th class="border-l border-violet-200 px-4 py-2 dark:border-violet-900/60">Дебет</th>
                                    <th class="px-4 py-2">Кредит</th>
                                    <th class="border-l border-violet-200 px-4 py-2 dark:border-violet-900/60">Дебет</th>
                                    <th class="px-4 py-2">Кредит</th>
                                    <th class="border-l border-violet-200 px-4 py-2 dark:border-violet-900/60">Дебет</th>
                                    <th class="px-4 py-2">Кредит</th>
                                    <th class="border-l border-violet-200 px-4 py-2 dark:border-violet-900/60">Начислено</th>
                                    <th class="px-4 py-2">Корректировка</th>
                                    <th class="px-4 py-2">Оплачено</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-zinc-200 bg-white dark:divide-zinc-800 dark:bg-zinc-900">
                                <tr>
                                    <td class="px-4 py-3 font-medium">800001</td>
                                    <td class="px-4 py-3">Должник</td>
                                    <td class="px-4 py-3 text-zinc-500 dark:text-zinc-400">Алмалинский, Абая, д. 10, кв. 1</td>
                                    <td class="px-4 py-3">20</td>
                                    <td class="px-4 py-3">1 000.00</td>
                                    <td class="px-4 py-3 text-zinc-400 dark:text-zinc-600">—</td>
                                    <td class="px-4 py-3">5 500.00</td>
                                    <td class="px-4 py-3">2 000.00</td>
                                    <td class="px-4 py-3 font-semibold text-rose-700 dark:text-rose-300">4 500.00</td>
                                    <td class="px-4 py-3 text-zinc-400 dark:text-zinc-600">—</td>
                                ...
                                <tr>
                                    <td class="px-4 py-3 font-medium">800002</td>
                                    <td class="px-4 py-3">Переплатил</td>
                                    <td class="px-4 py-3 text-zinc-500 dark:text-zinc-400">Есильский, Кабанбай батыра, д. 20, кв. 2</td>
                                    <td class="px-4 py-3 text-zinc-400 dark:text-zinc-600">-</td>
                                    <td class="px-4 py-3 text-zinc-400 dark:text-zinc-600">—</td>
                                    <td class="px-4 py-3">300.00</td>
                                    <td class="px-4 py-3">1 000.00</td>
                                    <td class="px-4 py-3">2 700.00</td>
                                    <td class="px-4 py-3 text-zinc-400 dark:text-zinc-600">—</td>
                                    <td class="px-4 py-3 font-semibold text-emerald-700 dark:text-emerald-300">2 000.00</td>
                                    <td class="px-4 py-3">1 000.00</td>
                                ...
                                <tr class="bg-zinc-50 font-semibold dark:bg-zinc-950">
                                    ...
                                    <td class="px-4 py-3">1 000.00</td>
                                    <td class="px-4 py-3">300.00</td>
                                    <td class="px-4 py-3">6 500.00</td>
                                    <td class="px-4 py-3">4 700.00</td>
                                    <td class="px-4 py-3">4 500.00</td>
                                    <td class="px-4 py-3">2 000.00</td>
                                    <td class="px-4 py-3">6 000.00</td>
                                    <td class="px-4 py-3">300.00</td>
                                    <td class="px-4 py-3">4 500.00</td>
                                </tr>
                            </tbody>
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
                        <div class="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-800 dark:bg-zinc-950">
                            <p class="text-xs font-semibold uppercase tracking-wide text-zinc-500 dark:text-zinc-400">Закрытый расчётный месяц</p>
                            <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-300">
                                Месяц зафиксирован, поэтому значения берутся из начислений. В ведомость попадают только абоненты, у которых есть начисление за этот месяц.
                            </p>
                        </div>

                        <div class="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-900/60 dark:bg-amber-950/30">
                            <p class="text-xs font-semibold uppercase tracking-wide text-amber-700 dark:text-amber-300">Незакрытый расчётный месяц</p>
                            <p class="mt-2 text-sm text-amber-800/80 dark:text-amber-200/80">
                                В ведомость попадают все активные абоненты. Начальное сальдо берётся из прошлого закрытия и входящих остатков периода, начисление и объём — из квитанции периода, оплата — из оплат, корректировка — из корректировок сальдо, кроме входящих остатков. Квитанция создаётся при сохранении показания, поэтому у абонентов с фиксированной суммой и расчётом на человека начислено остаётся нулевым до закрытия месяца.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                ...
                <div class="grid gap-4 border-b border-zinc-200 p-6 dark:border-zinc-800 lg:grid-cols-2">
                    <div class="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                        ...
                        <p class="mt-2 text-sm leading-6 text-zinc-500 dark:text-zinc-400">
                            HTML-шаблон по умолчанию с плейсхолдерами @verbatim{{переменная}}@endverbatim: шапка, абонент и реквизиты, таблица счётчиков, итоги. Используется, пока организация не сохранила свой шаблон, и служит стартовым содержимым редактора.
                        </p>
                    </div>
