                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
                        ...
                        <div class="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-900/60 dark:bg-amber-950/30">
                            ...
                            <p class="mt-2 text-sm text-amber-800/80 dark:text-amber-200/80">
                                В ведомость попадают все активные абоненты. Начальное сальдо берётся из прошлого закрытия, начисление — из квитанции периода, оплата — из оплат, корректировка — из корректировок сальдо. Квитанция создаётся при сохранении показания, поэтому у абонентов с фиксированной суммой и расчётом на человека начислено остаётся нулевым до закрытия месяца.
                            </p>
                        </div>
                    </div>
                </div>
