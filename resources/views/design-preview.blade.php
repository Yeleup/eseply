                ...
                <div class="border-b border-zinc-200 p-4 dark:border-zinc-800">
                    <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                        <div>
                            ...
                            <p class="mt-1 max-w-3xl text-sm text-zinc-500 dark:text-zinc-400">
                                Сводка использует те же строки отчёта, но группирует их по городам, районам, улицам или контроллерам. Если абонент подходит нескольким контроллерам, он отображается в строке каждого подходящего контроллера. Последняя строка сводки — «Итого».
                            </p>
                        </div>
